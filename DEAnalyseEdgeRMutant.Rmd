...
data_mutant = read.table("quantif_mutants.txt", h=F)
...
On a 434+369 gènes différentiellement exprimés avec un seuil pour la pvalue ajustée de 5%. 
...
Sur ces 803 gènes DE, 30 contiennent le mot "kinase" dans leur description, 8 le mot calcium.
