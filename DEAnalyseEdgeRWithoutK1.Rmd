---
title: "DE Analyse EdgeR Sans K1"
...
```{r filter}
y <- DGEList(counts=data, group = c(1,1,2,2,2))
y$samples
keep <- filterByExpr(y)
...
On a plus de 200 gènes différentiellement exprimés avec un seuil pour la pvalue ajustée de 5%. 
...
save(file = "DEGenesEdgeRWithoutK1.RData", DEGenesNames)
```
